                    ...
                    <div className="w-full py-6 z-20">
                        ...
                        <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            <div className="pb-2 pt-4">
                                <input type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-gray-900" onChange={(e) => { setlogin({ ...login, email: e.target.value }) }} />
                            </div>
                            <div className="pb-2 pt-4">
                                <input className="block w-full p-4 text-lg rounded-sm bg-gray-900" type="password" name="password" id="password" placeholder="Password" onChange={(e) => { setlogin({ ...login, password: e.target.value }) }} />
                            </div>
                            <div className="text-gray-400 hover:underline hover:text-black">
                                <a href="#">Forgot your password?</a>
                            </div>
                            <div className="px-4 pb-2 pt-4 flex gap-4">
                                <button onClick={() => setisLogin(true)} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">login</button>
                                <button onClick={() => setisLogin(false)} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">sign in</button>
                            </div>
